...
#Chart
# Note that the asthma_mortality_chart1PRA path is correct - this is a workaround to use an existing private chart
...
plot_webchart(filepath="COPD/COPD_deprivation_Chart_1_PRA", chart_type = "multibar", privacy = "secret",
         xvar="class1", yvar="measure", group="class2", pal_col=palnogroups,
         title="Chart 1. COPD admissions in males, Scotland, 2021/22",
         sourc="<a href='https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/acute-hospital-activity-and-nhs-beds-information-annual/'>SMR01, PHS</a>. ICD10 Codes: J40-J44",
         xaxtitle='SIMD quintile', yaxtitle="Age-sex standardised rate per 100,000")
...
plot_webchart(filepath="COPD/COPD_deprivation_Chart_2_PRA", chart_type = "multibar", privacy = "secret",
         xvar="class1", yvar="measure", group="class2", pal_col=palnogroups,
         title="Chart 2. COPD admissions in females, Scotland, 2021/22",
         sourc="<a href='https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/acute-hospital-activity-and-nhs-beds-information-annual/'>SMR01, PHS</a>. ICD10 Codes: J40-J44",
         xaxtitle='SIMD quintile', yaxtitle="Age-sex standardised rate per 100,000")
...
plot_webchart(filepath="COPD/COPD_NHSboard_Chart_2_PRA", chart_type = "barcompar", privacy = "secret",
          xvar="class1", yvar="measure", comparator="comparator", compname="Scotland",
          title="Chart 2. Hospital discharges <br>with COPD (main diagnosis), 2021/22",
          sourc="<a href='https://beta.isdscotland.org/find-publications-and-data/health-services/hospital-care/acute-hospital-activity-and-nhs-beds-information-annual/'>SMR01, PHS</a>. ICD10 codes J40-J44.",
          xaxtitle='NHS Board', yaxtitle="Crude rate per 100,000 population")
...
#Crime - by local authority Chart 1 no longer in use therefore chart hijacked for stalling mortality.
...
#crime-national-target-chart1 no longer in use therefore chart hijacked for stalling mortality.
...
#crime-national-target-chart2 no longer in use therefore chart hijacked for stalling mortality.
...
plot_webchart(filepath="Deaths/deaths-allcause-byhb-chart1", chart_type = "barcompar",
          xvar="class1", yvar="measure", comparator="comparator", compname="Scotland",
          title="Chart 1. All-cause death rates by NHS Board, 2020",
...
plot_webchart(filepath="Deaths/deaths-allcause-byLA-chart1", chart_type = "barcompar",
          xvar="class1", yvar="measure", comparator="comparator", compname="Scotland",
          title="Chart 1. All-cause death rates by council, 2020",
          sourc="<a href='https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/deaths/age-standardised-death-rates-calculated-using-the-esp'>NRS</a>.",
...
plot_webchart(filepath="Deaths/deaths-allcause-deprivation-chart1", chart_type = "barcompar",
          xvar="class1", yvar="measure", comparator="comparator", compname="Scotland",
          title="Chart 1. All-cause death rates by deprivation quintile, 2020",
          sourc="<a href='https://www.nrscotland.gov.uk/statistics-and-data/statistics/statistics-by-theme/vital-events/deaths/age-standardised-death-rates-calculated-using-the-esp'>NRS</a>. ",
          xaxtitle='SIMD quintile', yaxtitle="Age-sex standardised rate per 100,000")
...
plot_webchart(filepath="Epilepsy/Epilepsy_incidence_deaths_Chart_1", chart_type = "multiline",
           xvar="class2", yvar="measure", group="class1", xtick_freq=1, pal_col=palbysexoverall,
...
plot_webchart(filepath="Health Inequalities/Health_Inequalities_Chart_1_new",
        ...
        sourc="<a href='https://www.gov.scot/publications/long-term-monitoring-health-inequalities-march-2022-report/'>Long-term Monitoring of Health Inequalities, Scottish Government</a>",
...
plot_webchart(filepath="Health Inequalities/Health_Inequalities_Chart_3",
             ...
             sourc="<a href='https://www.gov.scot/publications/long-term-monitoring-health-inequalities-january-2021-report'>Long-term Monitoring of Health Inequalities, Scottish Government</a>",
             xaxtitle="Year", yaxtitle="Relative Index of Inequality (RII)",
...
plot_webchart(filepath="Health Inequalities/Health_Inequalities_Chart_4", chart_type = "onebar",
       xvar="class1", yvar="measure",
       title="Chart 4. Age-standardised all-cause mortality rates<br>(under 75 years) by deprivation decile, Scotland 2019",
       sourc="<a href='https://www.gov.scot/publications/long-term-monitoring-health-inequalities-january-2021-report'>Long-term Monitoring of Health Inequalities, Scottish Government</a>",
...
plot_webchart(filepath="Income and employment/IE-household-income-chart1", chart_type = "multiline",
           ...
           sourc="<a href='https://www.gov.uk/government/collections/households-below-average-income-hbai--2'>Scottish Government analysis of the Family Resources Survey,
           Households Below Average Incomes dataset</a>",
           xaxtitle="3-year average", yaxtitle="£ per week")

plot_webchart(filepath="Income and employment/IE-household-income-chart2", chart_type = "multiline",
          xvar="class1", yvar="measure", group="class2", pal_col=pal_gradient9,
...
plot_webchart(filepath="Income and employment/IE-working-age-poverty-chart2", chart_type = "multiline",
          xvar="class1", yvar="measure", group="class2", pal_col=pal2bysex,
          ...
          sourc="<a href='https://www.gov.uk/government/collections/households-below-average-income-hbai--2'>Scottish Government analysis of
          the Family Resources Survey, Households Below Average Incomes dataset</a>",
...
plot_webchart(filepath="Income and employment/IE-availabilityofwork-chart3", chart_type = "oneline",
       xvar="class1", yvar="measure", xtick_freq=4, order=TRUE,
